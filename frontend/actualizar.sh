...
REPO_URL="https://github.com/LiquorStore-APP/liquor-store-web.git"
CONTAINER_NAME="liquor-frontend"
IMAGE_NAME="frontend-liquor-frontend"
SCRIPT_TO_EXECUTE="F:/DOCUMENTOS/LiquorStore-APP/liquor-store-deploy-utils/frontend/desplegar.sh"

# Archivo temporal para almacenar el hash del último commit conocido
LAST_COMMIT_FILE="/tmp/last_commit_hash.txt"
